...
use mpl_token_metadata::instructions::{ CreateMasterEditionV3Cpi, CreateMasterEditionV3InstructionArgs, CreateMetadataAccountV3Cpi, CreateMetadataAccountV3InstructionArgs};
...
pub fn create_nft(
    ...
    let metadata_account_res = metadata_account_cpi.invoke();
    match metadata_account_res{
